...
- **Dataset:** YOLO-format merged dataset at `C:\FYP_v2\prepared_datasets\trashnet` (config: `C:\FYP_v2\prepared_datasets\trashnet\data.yaml`).
- **Classes defined in `data.yaml`:** **6** — cardboard, glass, metal, paper, plastic, trash.
- **Classes used in this ML run:** **6** — cardboard, glass, metal, paper, plastic, trash.
...
- Classes in this run: cardboard, glass, metal, paper, plastic, trash
...
## Data
- Train object crops: **1946**
- Test object crops: **253**
...
- Compared to the dataset average, **cardboard** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `p50_intensity, mean_intensity, p10_intensity`; strongest frequency shifts involve `fft_bin_2, high_freq_energy, fft_bin_5`.
  - *Scores:* overall `26.8393`, spatial `13.0115`, frequency `0.0026`.
- Compared to the dataset average, **plastic** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `p10_intensity, grad_std, grad_mean`; strongest frequency shifts involve `fft_bin_1, fft_bin_2, fft_bin_3`.
  - *Scores:* overall `21.7563`, spatial `18.6661`, frequency `0.0092`.
- Compared to the dataset average, **trash** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `grad_mean, p50_intensity, grad_std`; strongest frequency shifts involve `fft_bin_1, fft_bin_2, fft_bin_3`.
  - *Scores:* overall `16.8854`, spatial `9.0472`, frequency `0.0026`.
- Compared to the dataset average, **metal** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `grad_std, p10_intensity, grad_mean`; strongest frequency shifts involve `fft_bin_2, fft_bin_1, high_freq_energy`.
  - *Scores:* overall `15.9689`, spatial `15.9689`, frequency `0.0018`.
- Compared to the dataset average, **paper** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `grad_mean, grad_std, p90_intensity`; strongest frequency shifts involve `fft_bin_1, fft_bin_2, fft_bin_3`.
  - *Scores:* overall `13.5159`, spatial `10.7186`, frequency `0.0279`.
- Compared to the dataset average, **glass** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `p50_intensity, mean_intensity, grad_mean`; strongest frequency shifts involve `fft_bin_1, fft_bin_2, high_freq_energy`.
  - *Scores:* overall `9.7754`, spatial `8.3144`, frequency `0.0167`.
...
| rf | 0.7391 | 0.6688 |
| extra_trees | 0.7115 | 0.6597 |
| logreg | 0.6166 | 0.5622 |
| linear_svm | 0.5613 | 0.5155 |
| decision_tree | 0.5296 | 0.5073 |
