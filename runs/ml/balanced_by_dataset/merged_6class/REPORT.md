...
## Data
- Train object crops: **6000**
- Test object crops: **1450**
...
- Compared to the dataset average, **organic** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `grad_std, p90_intensity, grad_mean`; strongest frequency shifts involve `fft_bin_1, fft_bin_2, fft_bin_3`.
  - *Scores:* overall `38.7951`, spatial `29.0668`, frequency `0.0348`.
- Compared to the dataset average, **paper** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `p50_intensity, mean_intensity, grad_mean`; strongest frequency shifts involve `fft_bin_1, fft_bin_2, fft_bin_3`.
  - *Scores:* overall `28.9117`, spatial `22.5537`, frequency `0.0380`.
- Compared to the dataset average, **plastic** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `grad_mean, grad_std, p10_intensity`; strongest frequency shifts involve `fft_bin_1, fft_bin_2, fft_bin_3`.
  - *Scores:* overall `19.3602`, spatial `7.9624`, frequency `0.0174`.
- Compared to the dataset average, **metal** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `grad_mean, grad_std, p90_intensity`; strongest frequency shifts involve `fft_bin_1, fft_bin_3, high_freq_energy`.
  - *Scores:* overall `17.3331`, spatial `12.6349`, frequency `0.0048`.
- Compared to the dataset average, **cardboard** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `grad_mean, p10_intensity, p90_intensity`; strongest frequency shifts involve `fft_bin_1, high_freq_energy, fft_bin_2`.
  - *Scores:* overall `14.2290`, spatial `4.5765`, frequency `0.0102`.
- Compared to the dataset average, **glass** differs more in the **spatial** domain than in frequency: strongest spatial shifts involve `grad_std, p50_intensity, p10_intensity`; strongest frequency shifts involve `fft_bin_2, high_freq_energy, fft_bin_5`.
  - *Scores:* overall `12.2427`, spatial `10.7261`, frequency `0.0039`.

## ML results (features → models)
| Model | Accuracy | F1-macro |
|---|---:|---:|
| xgboost | 0.6497 | 0.6422 |
| extra_trees | 0.6110 | 0.6031 |
| rf | 0.5917 | 0.5814 |
| linear_svm | 0.5352 | 0.5262 |
| logreg | 0.5234 | 0.5161 |
| decision_tree | 0.4303 | 0.4253 |
